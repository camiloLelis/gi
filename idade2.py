...
idcerta=re.sub(r'days,','dias que viveu', str(idade)) #usei o metodo re.sub() que substitui o 1º texto do 1ºparametro pelo 2ºsegundo , no que estiver no 3ºparametro
print(idcerta)
#print(idade)